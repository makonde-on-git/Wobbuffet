#!/usr/bin/python3
"""Wobbuffet launcher with auto-restart ability.
...
Exit codes:
    ...
    ===== ======== ===========
    0     SHUTDOWN Close down launcher.
    1     CRITICAL Inform of crash and attempt restart by default.
    26    RESTART  Restart Wobbuffet.
    ===== ======== ===========
"""
...
def main():
    ...
    # show intro banner
    print("==========================================\n"
          "Wobbuffet - Discord Bot for Pokemon Go PvP\n"
          "==========================================\n")
    ...
    while True:
        ...
        # if restart request
            ...
            if '--from-restart' not in bot_args:
                bot_args.append('--from-restart')
