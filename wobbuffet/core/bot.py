...
from wobbuffet import config
from wobbuffet.core.context import Context
from wobbuffet.core.data_manager import DatabaseInterface, DataManager
from wobbuffet.utils import ExitCodes, fuzzymatch, make_embed, pagination
...
class Bot(commands.AutoShardedBot):
    ...
    dbi: :class:`wobbuffet.core.data_manager.dbi.DatabaseInterface`
    ...
    def __init__(self, **kwargs):
        ...
        self.logger = logging.getLogger('wobbuffet.Bot')
    ...
    async def _db_connect(self):
        try:
            ...
            db_name = self.config.db_details.get('database', 'wobbuffet')
            print(
    ...
    def get_category(self, category):
        ...
        entries = sorted(self.commands, key=sort_key)
        categories = []
        for cmd_group, __ in itertools.groupby(entries, key=group_key):
            if cmd_group != '\u200b':
    ...
    @cached_property
    def version(self):
        return pkg_resources.get_distribution("wobbuffet").version
